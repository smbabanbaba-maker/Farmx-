export const NIGERIA_STATES_LGAS: Record<string, string[]> = {
  ...
  Adamawa: [
    "Demsa", "Fufure", "Ganye", "Girei", "Gombi", "Gujba", "Guyuk", "Hong",
  ...
  Borno: [
    "Abadam", "Askira/Uba", "Bama", "Bayo", "Biu", "Chibok", "Damboa", "Diyeri",
  ...
  Edo: [
    ...
    "Ikpoba Okha", "Orhionmwon", "Oredo", "Ovia North-East", "Ovia South-West", "Owan East", "Owan West", "Uhunmwonde"
  ],
  Ekiti: [
  ...
  Katsina: [
    ...
    "Dan Musa", "Daura", "Dutsi", "Dutsin Ma", "Faskari", "Funtua", "Ingawa",
  ...
  Niger: [
    ...
    "Gurara", "Katcha", "Kontagora", "Lapai", "Mariga", "Mashegu", "Mokwa",
  ...
  Ondo: [
    "Akoko North-East", "Akoko North-West", "Akoko South-Akure", "Akoko South-West",
  ...
  Sokoto: [
    ...
    "Sokoto North", "Sokoto South", "Tambuwal", "Tureta", "Wamako", "Wurno", "Yabo", "Zaria"
  ],
  Taraba: [
